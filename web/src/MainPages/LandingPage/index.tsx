...
const WebServiceLanding = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main
        id="home"
        className="flex-grow container mx-auto px-4 grid md:grid-cols-2 items-center gap-12 py-16"
      >
        <div>
        ...
        <div className="grid md:grid-cols-2 gap-6 items-start max-w-5xl mx-auto">
          {faqs.map((faq, index) => (
            <div
              ...
              className={`bg-gray-100 p-6 rounded-xl shadow-lg border border-gray-200 transition-all duration-300 transition-all duration-300 hover:shadow-xl ${
                openIndex === index
